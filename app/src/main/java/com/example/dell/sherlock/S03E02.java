 ...
 */
public class S03E02 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("SHERLOCK : SEASON 3");
        View rootView = inflater.inflate(R.layout.episodes, container, false);//
       //
        iv=(ImageView) rootView.findViewById(R.id.video);
        iv.setImageResource(R.drawable.vs3e2);
        for(int i=0;i<2;i++) {
            iv1=(ImageView)rootView.findViewById(bs[i]);
            iv1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                   Intent i=new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.youtube.com/watch?vqtGf6RvjWE4"));
                    startActivity(i);
                }
            });
        }
        ...
        imageView.setImageResource(R.drawable.s03e02);
        ...
        t.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.imdb.com/title/tt2781042/reviews?ref_=tt_ov_rt"));
                startActivity(i);
            }
        });
        t=(TextView)rootView.findViewById(R.id.critics);
        t.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.imdb.com/title/tt2781042/externalreviews?ref_=tt_ov_rt"));
                startActivity(i);
            }
        });
