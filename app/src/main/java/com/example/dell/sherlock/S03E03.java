 ...
 */
public class S03E03 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        iv.setImageResource(R.drawable.vs3e3);
        for(int i=0;i<2;i++) {
            iv1=(ImageView)rootView.findViewById(bs[i]);
            iv1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i=new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.youtube.com/watch?vxhjIsu7n6bI"));
                    startActivity(i);
                }
            });
        }
        ...
        imageView.setImageResource(R.drawable.s03e03);
