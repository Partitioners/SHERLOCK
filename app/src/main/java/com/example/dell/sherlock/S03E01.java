 ...
 */
public class S03E01 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("SHERLOCK : SEASON 3");
        View rootView = inflater.inflate(R.layout.episodes, container, false);//
       //
        iv=(ImageView) rootView.findViewById(R.id.video);
        iv.setImageResource(R.drawable.vs3e1);
        for(int i=0;i<2;i++) {
            iv1=(ImageView)rootView.findViewById(bs[i]);
            iv1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i=new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.youtube.com/watch?vO7cKIjNIPoY"));
                    startActivity(i);
                }
            });
        }
        ...
        imageView.setImageResource(R.drawable.s03e01);
