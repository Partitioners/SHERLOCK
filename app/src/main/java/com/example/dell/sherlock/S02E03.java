 ...
 */
public class S02E03 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        iv.setImageResource(R.drawable.vs2e3);
        for(int i=0;i<2;i++) {
            iv1=(ImageView)rootView.findViewById(bs[i]);
            iv1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i=new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.youtube.com/watch?v=eKRCt3yCXEA"));
                    startActivity(i);
                }
            });
        }
        ...
        imageView.setImageResource(R.drawable.s02e03);
